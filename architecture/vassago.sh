...
##安装链码
./network.sh deployCC -c dbchain -ccn dbchaincode -ccp ../vassago/DBChaincode2 -ccl go
./network.sh deployCC -c tb1chain -ccn tb1chaincode -ccp ../vassago/TB1Chaincode -ccl go
./network.sh deployCC -c tb2chain -ccn tb2chaincode -ccp ../vassago/TB2Chaincode -ccl go
./network.sh deployCC -c tb3chain -ccn tb3chaincode -ccp ../vassago/TB3Chaincode -ccl go
./network.sh deployCC -c tb4chain -ccn tb4chaincode -ccp ../vassago/TB4Chaincode -ccl go
./network.sh deployCC -c tb5chain -ccn tb5chaincode -ccp ../vassago/TB5Chaincode -ccl go
./network.sh deployCC -c tb6chain -ccn tb6chaincode -ccp ../vassago/TB6Chaincode -ccl go
